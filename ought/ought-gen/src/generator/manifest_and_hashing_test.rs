//! Generated tests for the `manifest_and_hashing` subsection of the `generator` spec.
//!
...
fn test_generator__manifest_and_hashing__must_compute_a_clause_hash_from_the_keyword_clause_text_context_m() {
    ...
    let spec_must = OughtMdParser.parse_string(
    ...
    let spec_must2 = OughtMdParser.parse_string(
        "# Spec\n\n## Section\n\n- **MUST** validate the token\n",
        &path,
    )
    .expect("parse must succeed");
    ...
    let spec_should = OughtMdParser.parse_string(
    ...
    let spec_other_text = OughtMdParser.parse_string(
    ...
    let spec_given = OughtMdParser.parse_string(
